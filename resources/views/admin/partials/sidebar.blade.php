  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <!-- <div class="image">
          <img src="{{asset('image/logo/rudralogo.png')}}" class="img-circle elevation-2" alt="User Image">
        </div> -->
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <!-- <li class="nav-item">
                <a href="{{route('house-bikanari.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add</p>
                </a>
              </li> -->
              <li class="nav-item">
                <a href="{{route('house-bikanari.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('contactusindex')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Contact Us List</p>
                </a>
              </li>
